        ...
        {!isCrmRoute && (
          <>
            <header className="bg-[#0a0a0a] border-b border-white/10 fixed top-0 left-0 right-0 z-30 shadow-xl w-full h-12 sm:h-14 overflow-hidden">
              {/* Decorative Background Element - Exact Brand 'a' SVG Path */}
              <div className="absolute right-[30px] top-1/2 -translate-y-[45%] pointer-events-none opacity-50 select-none transform -skew-x-12 blur-[0.4px]">
                <svg viewBox="4.8 15 6 5.8" className="h-[140px] w-auto">
                  <path
                    fill="#3490c7"
                    fillRule="evenodd"
