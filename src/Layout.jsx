  ...
  return (
    <div className={`bg-white flex overflow-x-hidden ${isCrmRoute ? 'h-screen overflow-hidden' : 'min-h-screen'}`}>
      ...
      <div className="flex-1 flex flex-col">
        ...
        {!isCrmRoute && (
          <>
            <header className="bg-[#0a0a0a] border-b border-white/10 fixed top-0 left-0 right-0 z-30 shadow-xl w-full h-12 sm:h-14">
              ...
              <div className="relative z-10 w-full h-full px-1.5 sm:px-4 flex items-center justify-between text-white">
                ...
                <div className="flex items-center gap-2 md:gap-3 shrink-0">
                  ...
                  <div className="relative ml-auto flex items-center">
                    ...
                    {accountOpen && (
                      <div className="absolute top-full right-0 mt-2 w-64 rounded-xl border border-gray-200 bg-white shadow-lg p-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
