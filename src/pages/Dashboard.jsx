...
export default function Dashboard() {
  ...
  return (
    <div className="bg-white p-2 sm:p-4 w-full flex flex-col items-center justify-center">
      <div className="max-w-4xl mx-auto w-full flex flex-col items-center py-4">
