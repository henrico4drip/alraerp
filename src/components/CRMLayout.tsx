    ...
    <div className="flex h-screen overflow-hidden bg-gray-50">
      ...
      <main className="flex-1 overflow-hidden relative">
        ...
        <div className="md:hidden h-14 flex items-center justify-between px-4 border-b border-white/10 bg-[#0a0a0a] text-white shadow-md overflow-hidden relative">
          <div className="absolute right-[5px] top-[50%] -translate-y-1/2 pointer-events-none opacity-40 select-none">
            <span className="text-[280px] font-black italic text-[#3490c7] blur-[1px] leading-none block mt-[10px] -mr-[10px] transform -skew-x-[12deg]" style={{ fontFamily: `'Poppins', sans-serif` }}>a</span>
          </div>
